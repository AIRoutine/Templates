# AIRoutine.FullStack.UITests

Shared UI-Test-Infrastruktur fuer das AIRoutine.FullStack Projekt basierend auf **Uno.UITest**.
...
| `UITEST_ANDROID_PACKAGE` | Android Package Name | `com.companyname.airoutine.fullstack` |
| `UITEST_ANDROID_APK` | Pfad zur APK (CI/CD) | - |
| `UITEST_IOS_BUNDLE` | iOS Bundle ID | `com.companyname.airoutine.fullstack` |
